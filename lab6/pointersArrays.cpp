...
int main(){
    ...
    *pPointer = 10; // assign a value to the first element
    ...
    /*increment the pointer using 
    pointer rithmetic to assign the address of 
    the second element to the pointer*/
    pPointer++;
    *pPointer = 20; //assign a value to the second tuple_element
    ...
    *pPointer = 30; // assign a value to the third element
    ...
    /*assign the address of the four element to the pointer
    using pointer arithmetic*/

    pPointer = numbersArray + 3;
    *pPointer = 40; // asssign a value to the fourth element

    //assign the address of the first element to the pointer
    pPointer = numbersArray;

    /*assign a value to the fifth element
     using indirection and pointer arithmetic*/
     *(pPointer + 4) = 50;
